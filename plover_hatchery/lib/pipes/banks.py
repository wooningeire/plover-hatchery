...
from .join import JoinedTriePaths, NodeSrc, join_on_strokes, tuplify
    ...
    class BeforeCompleteConsonant(Protocol):
        def __call__(self,
            *,
            ...
            left_node: "int | None",
            right_node: "int | None",
            left_paths: JoinedTriePaths,
            right_paths: JoinedTriePaths,
        ) -> None: ...
    ...
    *,
    ...
    def plugin(get_plugin_api: GetPluginApi, **_):
        ...
        def _(state: BanksState, phoneme: SophemeSeqPhoneme, **_):
            ...
            left_paths = join_on_strokes(state.trie, state.left_srcs, left_chords(phoneme), state.entry_id)
            right_paths = join_on_strokes(state.trie, state.right_srcs, right_chords(phoneme), state.entry_id)

            left_node = left_paths.dst_node_id
            right_node = right_paths.dst_node_id
            ...
            on_before_complete_consonant(state, phoneme, left_node, right_node, left_paths, right_paths)
