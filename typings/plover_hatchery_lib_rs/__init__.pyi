...
class ChordToSophSearchMatch:
    @property
    def soph_result(self) -> Any: ...
    @property
    def chord_starting_key_index(self) -> int: ...

    def __init__(self, soph_result: Any, chord_starting_key_index: int, /) -> None: ...


class ChordToSophSearcher:
    def __init__(self, entries: Sequence[tuple[Sequence[str], Any]], /) -> None: ...
