...
class AsteriskableKey:
    ...
    def __init__(self, key: str, asterisk: bool, /) -> None: ...

    @staticmethod
    def annotations_from_outline(outline_steno: str, /) -> tuple[AsteriskableKey, ...]: ...

    @staticmethod
    def annotations_from_strokes(strokes: Any, /) -> tuple[AsteriskableKey, ...]: ...


class SoundSymbolKind:
    @staticmethod
    def abstract_symbol(value: str, /) -> SoundSymbolKind: ...

    @staticmethod
    def broad_ipa(value: str, /) -> SoundSymbolKind: ...

    @staticmethod
    def narrow_ipa(value: str, /) -> SoundSymbolKind: ...
...
class SoundSymbol:
    ...
    @staticmethod
    def new_abstract(value: str, stress: int, optional: bool, /) -> SoundSymbol: ...

    @staticmethod
    def new_broad_ipa(value: str, stress: int, optional: bool, /) -> SoundSymbol: ...

    @staticmethod
    def new_narrow_ipa(value: str, stress: int, optional: bool, /) -> SoundSymbol: ...

    @staticmethod
    def new_with_known_base_symbol(symbol: str, base_symbol: str, stress: int, optional: bool, /) -> SoundSymbol: ...
...
Keysymbol: TypeAlias = SoundSymbol
...
class Sopheme:
    ...
    def chars(self) -> str: ...
    @property
    def sound_symbols(self) -> list[SoundSymbol]: ...
    @property
    def keysymbols(self) -> list[SoundSymbol]: ...

    def __init__(self, chars: str, sound_symbols: list[SoundSymbol], /) -> None: ...
...
class DefView:
    ...
    def foreach_keysymbol(self, callable: Callable[[DefViewCursor, SoundSymbol], None], /) -> None: ...
...
class DefViewItem:
    ...
    def keysymbol(self) -> SoundSymbol: ...
    ...
    class Keysymbol(DefViewItem):
        ...
        __keysymbol: SoundSymbol
        def __init__(self, keysymbol: SoundSymbol, /) -> None: ...
...
def add_diphthong_keysymbols(view: DefView, map_keysymbols: Callable[[DefViewCursor], Sequence[SoundSymbol]], /) -> Def: ...
...
def parse_sound_symbol_seq(seq: str, /) -> list[SoundSymbol]:
    """Parse a string into a list of SoundSymbol objects."""
    ...

def parse_keysymbol_seq(seq: str, /) -> list[Keysymbol]:
    """Parse a string into a list of legacy abstract SoundSymbol objects."""
    ...
...
class Trie:
    ...
    def follow(self, src_node: int, key: Any, /) -> int: ...
    def follow_chain(self, src_node: int, keys: Sequence[Any], /) -> int: ...
    def traverse(self, src_node: int, key: Any, /) -> int | None: ...
    def traverse_chain(self, src_node: int, keys: Sequence[Any], /) -> int | None: ...
    def set_translation(self, node: int, translation: Any, /) -> None: ...
    def get_translation(self, node: int, /) -> Any | None: ...
    def node_has_translations(self, node: int, /) -> bool: ...
    def frozen(self, /) -> ReadonlyTrie: ...
...
class NondeterministicTrie:
    ...
    def from_state(
        transitions: Any,
        node_translations: Any,
        transition_costs: Any,
        used_nodes_by_translation: Any,
        /,
    ) -> NondeterministicTrie: ...

    @staticmethod
    def from_state_bytes(state: bytes, /) -> NondeterministicTrie: ...
...
class TransitionFlagManager:
    ...
    def export_state(self, /) -> Any: ...
    def export_state_bytes(self, /) -> bytes: ...
    def load_state(self, labels: Any, mappings: Any, /) -> None: ...
    def load_state_bytes(self, state: bytes, /) -> None: ...

    @staticmethod
    def from_state(labels: Any, mappings: Any, /) -> TransitionFlagManager: ...

    @staticmethod
    def from_state_bytes(state: bytes, /) -> TransitionFlagManager: ...
