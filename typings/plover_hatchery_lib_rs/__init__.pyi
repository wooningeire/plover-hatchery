...
class DefView:
    ...
    @property
    def first_consonant_loc(self) -> list[int] | None: ...
    @property
    def last_consonant_loc(self) -> list[int] | None: ...
    @property
    def first_vowel_loc(self) -> list[int] | None: ...
    @property
    def last_vowel_loc(self) -> list[int] | None: ...
...
class DefViewCursor:
    ...
    def next_keysymbol_loc(self) -> DefViewCursor | None: ...
    def prev_keysymbol_loc(self) -> DefViewCursor | None: ...
